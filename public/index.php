...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['signup'])) {
    ...
    if ($stmt->fetch()) {
        ...
        // Optionally, you can auto-open the login modal after signup
    }
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['login'])) {
    ...
    if ($user && password_verify($password, $user['password'])) {
        ...
        $login_success = "Login successful! Welcome back, " . htmlspecialchars($user['username']) . ".";
        // Optionally, you can redirect after a short delay
        echo "<script>
          setTimeout(function(){ window.location = 'index.php'; }, 1200);
        </script>";
    } else {
...
<body class="bg-black text-danger">
  ...
  <main class="container py-5 text-center">
    ...
    <!-- Special Offers -->
    <section class="mb-5">
      <!-- Custom Multi-image Carousel Start -->
      <div class="position-relative mb-4 mx-auto" style="width: 100vw; max-width: none; left: 50%; right: 50%; transform: translateX(-50%); overflow: hidden;">
        <div id="multiImageCarousel" class="d-flex align-items-center" style="transition: transform 0.5s;">
          <img src="./assets/images/1.png" class="carousel-img mx-2 rounded"
            style="width: 300px; height: 200px; object-fit: cover;">
          <img src="./assets/images/2.png" class="carousel-img mx-2 rounded"
            style="width: 300px; height: 200px; object-fit: cover;">
          <img src="./assets/images/3.png" class="carousel-img mx-2 rounded"
            style="width: 300px; height: 200px; object-fit: cover;">
          <img src="./assets/images/4.png" class="carousel-img mx-2 rounded"
            style="width: 300px; height: 200px; object-fit: cover;">
          <img src="./assets/images/5.png" class="carousel-img mx-2 rounded"
            style="width: 300px; height: 200px; object-fit: cover;">
          <img src="./assets/images/6.png" class="carousel-img mx-2 rounded"
            style="width: 300px; height: 200px; object-fit: cover;">
          <img src="./assets/images/7.png" class="carousel-img mx-2 rounded"
            style="width: 300px; height: 200px; object-fit: cover;">
          <img src="./assets/images/8.png" class="carousel-img mx-2 rounded"
            style="width: 300px; height: 200px; object-fit: cover;">
          <img src="./assets/images/9.png" class="carousel-img mx-2 rounded"
            style="width: 300px; height: 200px; object-fit: cover;">
          <img src="./assets/images/10.png" class="carousel-img mx-2 rounded"
            style="width: 300px; height: 200px; object-fit: cover;">
        </div>
        <button id="multiPrev"
          class="btn btn-danger position-absolute top-50 start-0 translate-middle-y" style="z-index:2;">
          <i class="fas fa-chevron-left"></i>
        </button>
        <button id="multiNext"
          class="btn btn-danger position-absolute top-50 end-0 translate-middle-y" style="z-index:2;">
          <i class="fas fa-chevron-right"></i>
        </button>
      </div>
      <!-- Custom Multi-image Carousel End -->
    </section>
    ...
    <!-- removed category tiles section -->
  </main>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    const visible = 3; // Number of images visible at once
    const total = imgs.length;
    let animating = false;

    // Clone first N slides and append to end for seamless infinite loop
    ...
    let position = visible; // Start at first real slide (after prepended clones)

    function getImgWidth() {
      return imgs[0].offsetWidth + 16; // 16px margin (mx-2)
    }
    ...
    // Set initial position (after clones)
    ...
    function slideTo(newPosition) {
      ...
      updateCarousel();
      setTimeout(() => animating = false, 800); // Match animation duration
    }
